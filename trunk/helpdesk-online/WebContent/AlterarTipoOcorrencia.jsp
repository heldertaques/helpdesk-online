...
<title>Alteração - Tipo de Ocorrencia</title>
...
<h1>Alteração - Tipo de Ocorrência</h1>
<form action="AlterarTipoOcorrencia" method="post">
<table border="2">
<tr>
<td bordercolor="transparent">Codigo:<br><input type="text" name="codigo" id="codigo"  style="width: 80px" readonly="readonly" value="${param.codigo}"></td>
